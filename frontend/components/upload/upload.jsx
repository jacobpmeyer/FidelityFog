...
class Upload extends React.Component {
  ...
  render() {
    const preUpload = (
      <div className="user upload-content">
        <div className="pre-form-container">
          <div className="upload-greeting">Upload your tracks here</div>
          <input
            type="file"
            id="file"
    ...
    if (this.state.photoURL) {
      preview = <img src={this.state.photoURL} />;
      previewClass = "album-preview";
    } else {
      preview = (
        <>
          <li>album</li> <li>art</li> <li>preview</li>
        </>
      );
        ...
        <div className="user upload-content">
          <div className="form-container">
            ...
            <form className="upload-form" onSubmit={this.handleSubmit}>
              <div className="error-list big">{errorList}</div>
